				...
				$.ajax({
					...
					success : function (userInfo, response, status) {
						...
						if (userInfo) { 
							...
							$("#userInfo_classObj_classNumber_edit").combobox({
						        ...
						        onLoadSuccess: function () { //数据加载完毕事件
									$("#userInfo_classObj_classNumber_edit").combobox("select", userInfo.classObjPri);
							...
							$("#userInfo_zzmm_edit").val(userInfo.zzmm);
