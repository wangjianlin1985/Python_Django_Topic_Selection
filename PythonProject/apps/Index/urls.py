...
from apps.Index.views import MainTeacherView,IndexView,FrontLoginView,FrontLoginOutView,LoginView,LoginOutView,MainView,ChangePasswordView
...
urlpatterns = [
    ...
    url(r'^main_teacher$', MainTeacherView.as_view(), name='main_teacher'),  # 后台主页面
